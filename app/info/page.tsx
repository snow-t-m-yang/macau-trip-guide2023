const Infopage = () => {
  return (
    <div>
      ...
      >
        <h1 className="p-3 text-secondary text-2xl">航班資訊</h1>
        <div className=" grid grid-cols-2     h-[20dvh] w-[90%]   rounded-3xl bg-white/20">
          ...
          <p className="px-3 col-start-2 col-end-3 row-start-2 row-end-3 justify-self-start">
            NX615 0527
          </p>
          <p className=" col-start-1 col-end-2 row-start-3 row-end-4 justify-self-center  flex items-start w-[50%]">
            時間
          </p>
          <p className=" px-3 col-start-2 col-end-3 row-start-3 row-end-4 justify-self-start">
            20:05 - 22:00
          </p>
          <p className=" col-start-1 col-end-2 row-start-4 row-end-5 justify-self-center  flex items-start w-[50%]">
            地點
          </p>
          <p className="px-3 col-start-2 col-end-3 row-start-4 row-end-5 justify-self-start">
            {" "}
            台北桃園T1 - 澳門
          </p>
        </div>
